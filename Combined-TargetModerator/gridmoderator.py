...
def run_sum(threadnumber):
    result = subprocess.run([g4blloc,filename,f"ThreadNumber={threadnumber}",f"RandSeed={random.randint(0,2**32-1)}"], capture_output=True, text=True)
